...
def Imposta(menuPrinc):
	...
	temaImpostazioni.widget_font_color = (0,127,255)
...
def creazione_menuGioco():
	...
	temaPizzeria.widget_font_color = (0,100,255)
	#temaPizzeria.set_background_color_opacity(0.5)
...
main_menu = None
PATH_IMMAGINE_BG = "Immagini_Gioco/background_menu/blu1.jpg" #PATH (percorso della mia immagine da mettere come sfondo)
