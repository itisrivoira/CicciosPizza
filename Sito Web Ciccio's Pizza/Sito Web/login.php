			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center"><br><br>
						...
						<p>Completa il form per accedere</p>
						<br>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="contact-block">
						<form method="POST" id="loginForm" action="controllologin.php">
							<div class="row">
								<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" name="name" placeholder="Nome utente" required data-error="Please enter your username">
										</div>                                 
									</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<input type="password" placeholder="Password" id="pass" class="form-control" name="password" required data-error="Please enter your password">
									</div> 
								</div>
							</div>
							<div class="row">
						...
						<form method="get" action="./signin.php">
							<div class="submit-button text-center"> <br>
								<button class="btn btn-common" id="singin">Registrati</button>
							</div>
						</form>
					</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12">
						...
						<ul class="list-inline f-social">
							...
							<li class="list-inline-item"><a href="https://twitter.com"><i class="fa fa-twitter"></i></a></li>						</ul>
					</div>
				</div>
			</div>
			<br><br>
